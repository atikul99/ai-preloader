...
class Ai_Preloader_Admin {
    ...
    function display_options()
    {
        ...
        add_settings_field("loader-bg", "Preloader BG", array( $this, 'loader_bg_field_callback' ), "ai-menu-page", "header_section");
        add_settings_field("primary-color", "Primary Color", array( $this, 'primary_color_field_callback' ), "ai-menu-page", "header_section");
        add_settings_field("loader-img", "Preloader Image", array( $this, 'loader_img_field_callback' ), "ai-menu-page", "header_section");
	...
	function loader_bg_field_callback() { 
		...
		echo '<input type="text" name="loader_bg" value="' . get_option('loader_bg') . '" class="cpa-color-picker" data-alpha-enabled="true" data-default-color="rgba(34, 34, 34, 1)" >';
		echo '<p class="description">Choose background color, default color is #222.</p>';
	}
